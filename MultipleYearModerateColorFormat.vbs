...
Sub MultipleYearModerateColorFormat()
    ...
    ' Loop through all Ticker Symbols
        For i = 2 To LastRow
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                ' Set Green Color for price change greater or equal to 0 and red for less 0
                If ws.Range("J" & Ticker_Summary_Table_Row).Value >= "0" Then
                
                    ws.Range("J" & Ticker_Summary_Table_Row).Interior.ColorIndex = 4
                   
                   Else
                   
                   ws.Range("J" & Ticker_Summary_Table_Row).Interior.ColorIndex = 3
